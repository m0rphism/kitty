module Examples.SystemF-Kits.Soundness-Bigstep where
...
open import Examples.SystemF-Kits.Definitions hiding (Value; Neutral)
...
open import Examples.SystemF-Kits.SubjectReduction
