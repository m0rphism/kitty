...
Redˢ→Red : Red^ (suc k) e → Red e
Redˢ→Red (e'' , ↪-step e→e' e'→*e'') = _ , e→e'

Red→Red¹ : Red e → Red^ 1 e
Red→Red¹ (e' , e→e') = (e' , ↪-step e→e' ↪-refl)

Irred¹→Irred : Irred^ 1 e → Irred e
Irred¹→Irred irredᵏe red = irredᵏe (Red→Red¹ red)

Irred→Irredˢ : Irred e → Irred^ (suc k) e
Irred→Irredˢ irred redˢ = irred (Redˢ→Red redˢ)
