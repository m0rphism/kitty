module Kitty.Experimental.Examples.ISession.Definitions where
...
variable
  C C₁ C₂ C₃ C' C₁' C₂' : Term µ 𝕔
  ℂ ℂ₁ ℂ₂ ℂ₃ ℂ' ℂ₁' ℂ₂' : Term µ 𝕥
  T T₁ T₂ T₃ T' T₁' T₂' : Term µ 𝕥
  Σ Σ₁ Σ₂ Σ₃ Σ' Σ₁' Σ₂' : Term µ 𝕥
  N N₁ N₂ N₃ N' N₁' N₂' : Term µ 𝕥
  d d₁ d₂ d₃ d' d₁' d₂' : Term µ 𝕥
  S S₁ S₂ S₃ S' S₁' S₂' : Term µ 𝕥
  e e₁ e₂ e₃ e' e₁' e₂' : Term µ 𝕖
  v v₁ v₂ v₃ v' v₁' v₂' : Term µ 𝕧
  k k₁ k₂ k₃ k' k₁' k₂' : Term µ 𝕜
  s s₁ s₂ s₃ s' s₁' s₂' : Term µ 𝕤
  t t₁ t₂ t₃ t' t₁' t₂' : Term µ M
