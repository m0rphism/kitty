module Kitty.Experimental.Examples.SystemF-Kits-Uniform.SubjectReduction where
...
open import Kitty.Experimental.Examples.SystemF-Kits-Uniform.Definitions
