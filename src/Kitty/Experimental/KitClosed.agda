...
module Kitty.Experimental.KitClosed {𝕄 : Modes} (𝕋 : Terms 𝕄) where
...
open import Kitty.Kit 𝕋 hiding (_∋/⊢[_]_; _–[_]→_)
...
module Test (KT : KitTraversal) where
  ...
  module Test₂ where
    data [_⊔ₖ_]≡_ : Ren/Sub → Ren/Sub → Ren/Sub → Set where
      xX : ∀ {K₁ K₂} → [ K₁ ⊔ₖ K₂ ]≡ (K₁ ⊔ₖ K₂)

    lemx : ⦃ K K₁ K₂ : Ren/Sub ⦄ ⦃ _ : [ K₁ ⊔ₖ K₂ ]≡ K ⦄ →  K ≡ K₁ ⊔ₖ K₂
    lemx = {!!}

    _∘''_ : ⦃ K₁ K₂ K : Ren/Sub ⦄ ⦃ _ : [ K₂ ⊔ₖ K₁ ]≡ K ⦄ → µ₂ –[ K₁ ]→ µ₃ → µ₁ –[ K₂ ]→ µ₂ → µ₁ –[ K ]→ µ₃
    _∘''_ ⦃ K₁ ⦄ ⦃ Ren ⦄ ⦃ _ ⦄ ⦃ xX ⦄ ϕ₁ ϕ₂ _ x =  ϕ₂ _ x ⋯ ϕ₁ 
    _∘''_ ⦃ K₁ ⦄ ⦃ Sub ⦄ ⦃ _ ⦄ ⦃ xX ⦄ ϕ₁ ϕ₂ _ x = ϕ₂ _ x ⋯ ϕ₁ 

    _∘'''_ : ⦃ K₁ K₂ K : Ren/Sub ⦄ ⦃ _ : [ K₁ ⊔ₖ K₂ ]≡ K ⦄ → µ₂ –[ K₁ ]→ µ₃ → µ₁ –[ K₂ ]→ µ₂ → µ₁ –[ K ]→ µ₃
    _∘'''_ ⦃ Ren ⦄ ⦃ Ren ⦄ ⦃ _ ⦄ ⦃ xX ⦄ ϕ₁ ϕ₂ _ x =  ϕ₂ _ x ⋯ ϕ₁ 
    _∘'''_ ⦃ Ren ⦄ ⦃ Sub ⦄ ⦃ _ ⦄ ⦃ xX ⦄ ϕ₁ ϕ₂ _ x =  ϕ₂ _ x ⋯ ϕ₁ 
    _∘'''_ ⦃ Sub ⦄ ⦃ Ren ⦄ ⦃ _ ⦄ ⦃ xX ⦄ ϕ₁ ϕ₂ _ x = ϕ₂ _ x ⋯ ϕ₁ 
    _∘'''_ ⦃ Sub ⦄ ⦃ Sub ⦄ ⦃ _ ⦄ ⦃ xX ⦄ ϕ₁ ϕ₂ _ x = ϕ₂ _ x ⋯ ϕ₁ 

    tm-⋯-∘' : ⦃ K₁ K₂ K : Ren/Sub ⦄ ⦃ _ : [ K₁ ⊔ₖ K₂ ]≡ K ⦄ → (ϕ₁ : µ₁ –[ K₂ ]→ µ₂) (ϕ₂ : µ₂ –[ K₁ ]→ µ₃) (x : µ₁ ∋ m) →
      (`/id _ (ϕ₁ _ x) ⋯ ϕ₂) ≡ `/id _ ((ϕ₂ ∘''' ϕ₁) _ x)
    tm-⋯-∘' = {!!}
