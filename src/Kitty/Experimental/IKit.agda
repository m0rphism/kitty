...
module Kitty.Experimental.IKit {𝕄 : Modes} (𝕋 : Terms 𝕄) (T : KitTraversal 𝕋) (A : KitAssoc 𝕋 T) (AL : KitAssocLemmas A) (KT : KitType 𝕋) (IT : ITerms 𝕋 T A AL KT) where
...
open import Kitty.OPE 𝕋 T A AL KT
open Kitty.ITerms 𝕋 T A AL KT
