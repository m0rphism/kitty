...
record SubCompose : Set (lsuc ℓ) where
  ...
  module _ {M₁} {_∋/⊢₁_ : Scoped M₁} ⦃ 𝕂₁ : Kit _∋/⊢₁_ ⦄
           {M₂} {_∋/⊢₂_ : Scoped M₂} ⦃ 𝕂₂ : Kit _∋/⊢₂_ ⦄
           {M}  {_∋/⊢_ : Scoped M}   ⦃ 𝕂 : Kit _∋/⊢_ ⦄
    ...
    ~-cong-· :
      ...
      → ϕ₂ ~ ϕ₂'
      → (ϕ₁ ·ₖ ϕ₂) ~ (ϕ₁' ·ₖ ϕ₂')
    ~-cong-· {µ₁} {µ₂} {µ₃} {ϕ₁} {ϕ₁'} {ϕ₂} {ϕ₂'} ϕ₁~ϕ₁' ϕ₂~ϕ₂' = mk-~ λ m x →
    ...
    wk-cancels-,ₖ-· {µ₁} {µ₂} {m} ϕ x/t = mk-~ λ mx x →
  ...
  module _ where
    ...
    -- wk*-∥₁ ⦃ 𝕂 ⦄ {µ₁ = µ₁} {µ₂} {µ} ϕ₁ ϕ₂ = mk-~ λ where
    --   m x@(here {x = m₂} {xs = µ₂} refl) →
    --     let C = ckitᵣ in
    ...
    --                                                                                   (use-~-hom (↑*-▷ µ₂ m₂ (wkₖ* µ₁ id)) _ (here refl)) ⟩
    ...
    --                                                                                                     (sub' (wkₖ* µ₁ id ↑* µ₂))
    --                                                                                                     (ϕ₁ ∥ ϕ₂ ↓) y)) ⟩
    --     `/id (y & sub' (wkₖ* µ₁ id ↑* µ₂) ·[ C ] (ϕ₁ ∥ ϕ₂ ↓))                       ≡⟨ use-~ (wk*-∥₁ ϕ₁ (ϕ₂ ↓)) _ y ⟩
    --     `/id (y & ϕ₂ ↓)                                                             ≡⟨ cong `/id (&-↓ ϕ₂ y) ⟩
    --     `/id (x & ϕ₂)                                                               ∎
  ...
  _ᵣ·_ :
    ∀ {M} {_∋/⊢_ : Scoped M} ⦃ 𝕂₂ : Kit _∋/⊢_ ⦄
      {µ₁} {µ₂} {µ₃} → µ₁ –[ kitᵣ ]→ µ₂ → µ₂ –[ 𝕂₂ ]→ µ₃ → µ₁ –[ 𝕂₂ ]→ µ₃
  ρ ᵣ· ϕ = ρ ·ₖ ϕ

  _∘ᵣ_ :
    ∀ {M} {_∋/⊢_ : Scoped M} ⦃ 𝕂₂ : Kit _∋/⊢_ ⦄
      {µ₁} {µ₂} {µ₃} → µ₂ –[ 𝕂₂ ]→ µ₃ → µ₁ –[ kitᵣ ]→ µ₂ → µ₁ –[ 𝕂₂ ]→ µ₃
  ϕ₂ ∘ᵣ ϕ₁ = ϕ₁ ᵣ· ϕ₂
