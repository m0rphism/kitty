...
record ComposeKit ⦃ 𝕂₁ : Kit ⦄ : Set₁ where
  ...
  field
    ...
    -- dist-,ₖ-·ˡ : ∀ ⦃ 𝕊 : SubWithLaws ⦄ ⦃ 𝕂₂ : Kit ⦄ {m}
    --                (ϕ₁ : µ₁ –[ 𝕂₁ ]→ µ₂)
    --                (ϕ₂ : µ₂ –[ 𝕂₂ ]→ µ₃)
    --                (x/t : µ₂ ∋/⊢[ 𝕂₁ ] id/m→M m)
    --              → let sub = subst (µ₃ ∋/⊢[ 𝕂₁⊔ 𝕂₂ ]_) (ι-id/m→M m) in
    ...
    -- dist-,ₖ-·ʳ : ∀ ⦃ 𝕊 : SubWithLaws ⦄ ⦃ 𝕂₂ : Kit ⦄ {m}
    --                (ϕ₁ : µ₁ –[ 𝕂₁ ]→ µ₂)
    --                (ϕ₂ : µ₂ –[ 𝕂₂ ]→ µ₃)
    --                (x/t : µ₃ ∋/⊢[ 𝕂₂ ] id/m→M m)
...
dist-↑-ᵣ· : ∀ ⦃ 𝕊 : SubWithLaws ⦄ ⦃ 𝕂₂ : Kit ⦄ {µ₁} {µ₂} {µ₃} m
               (ϕ₁ : µ₁ –[ kitᵣ ]→ µ₂)
               (ϕ₂ : µ₂ –[ 𝕂₂ ]→ µ₃)
             → ((ϕ₁ ᵣ· ϕ₂) ↑ m) ~ ((ϕ₁ ↑ m) ᵣ· (ϕ₂ ↑ m))
dist-↑-ᵣ· ⦃ 𝕊 ⦄ ⦃ 𝕂₂ ⦄ {µ₁} {µ₂} {µ₃} m ϕ₁ ϕ₂ mx x@(here refl) =
  ...
  apₖ ((ϕ₁ ↑ m) ᵣ· (ϕ₂ ↑ m)) _ x      ∎
dist-↑-ᵣ· ⦃ 𝕊 ⦄ ⦃ 𝕂₂ ⦄ {µ₁} {µ₂} {µ₃} m ϕ₁ ϕ₂ mx x@(there y) =
...
tm-⋯-ᵣ· : ∀ ⦃ 𝕊 : SubWithLaws ⦄ ⦃ 𝕂₂ : Kit ⦄ {µ₁} {µ₂} {µ₃}
             (ϕ₁ : µ₁ –[ kitᵣ ]→ µ₂)
             (ϕ₂ : µ₂ –[ 𝕂₂ ]→ µ₃)
             (x : µ₁ ∋ m)
           → `/id _ (apₖ ϕ₁ _ x) ⋯ ϕ₂ ≡ `/id _ (apₖ (ϕ₁ ᵣ· ϕ₂) _ x)
tm-⋯-ᵣ· ⦃ 𝕊 ⦄ ⦃ 𝕂₂ ⦄ {µ₁} {µ₂} {µ₃} ϕ₁ ϕ₂ x =
  `/id _ (apₖ ϕ₁ _ x) ⋯ ϕ₂       ≡⟨⟩
...
record ComposeTraversal : Set₁ where
  ...
  field
    ⋯-assoc : ∀ ⦃ 𝕊 : SubWithLaws ⦄ ⦃ 𝕂₁ 𝕂₂ : Kit ⦄ ⦃ 𝔸 : ComposeKit ⦃ 𝕂₁ ⦄ ⦄
  ...
  tm-⋯-ₛ· : ∀ ⦃ 𝕊 : SubWithLaws ⦄ ⦃ 𝕊' : SubWithLaws ⦄ ⦃ 𝕂₂ : Kit ⦄ {µ₁} {µ₂} {µ₃}
            → let 𝕤' = SubWithLaws.SubWithLaws-Sub 𝕊' in
              (ϕ₁ : µ₁ –[ kitₛ ⦃ 𝕊 ⦄ ; 𝕤' ]→ µ₂)
              (ϕ₂ : µ₂ –[ 𝕂₂ ; 𝕤' ]→ µ₃)
              (x : µ₁ ∋ m)
            → `/id ⦃ kitₛ ⦃ 𝕊 ⦄ ⦄ _ (apₖ ϕ₁ _ x) ⋯ ϕ₂ ≡ `/id ⦃ kitₛ ⦃ 𝕊 ⦄ ⦄ _ (apₖ (ϕ₁ ₛ· ϕ₂) _ x)
  tm-⋯-ₛ· ⦃ 𝕊 ⦄ ⦃ 𝕊' ⦄ ⦃ 𝕂₂ ⦄ {µ₁} {µ₂} {µ₃} ϕ₁ ϕ₂ x =
    `/id ⦃ kitₛ ⦃ 𝕊 ⦄ ⦄ _ (apₖ ϕ₁ _ x) ⋯ ϕ₂    ≡⟨⟩
    (apₖ ϕ₁ _ x) ⋯ ϕ₂                          ≡⟨ sym (apₖ-post ϕ₁ (λ _ t → t ⋯ ϕ₂) x) ⟩
    apₖ (ϕ₁ ₛ· ϕ₂) _ x                         ≡⟨⟩
    `/id ⦃ kitₛ ⦃ 𝕊 ⦄ ⦄ _ (apₖ (ϕ₁ ₛ· ϕ₂) _ x) ∎

  open ComposeKit ⦃ … ⦄

  dist-↑-ₛ· : ∀ ⦃ 𝕊 : SubWithLaws ⦄ ⦃ 𝕊' : SubWithLaws ⦄ ⦃ 𝕂₂ : Kit ⦄ {µ₁} {µ₂} {µ₃} m
              → let 𝕤' = SubWithLaws.SubWithLaws-Sub 𝕊' in
                (ϕ₁ : µ₁ –[ kitₛ ⦃ 𝕊 ⦄ ; 𝕤' ]→ µ₂)
                (ϕ₂ : µ₂ –[ 𝕂₂ ; 𝕤' ]→ µ₃)
              → ((ϕ₁ ₛ· ϕ₂) ↑ m) ~ ((ϕ₁ ↑ m) ₛ· (ϕ₂ ↑ m))
  dist-↑-ₛ· ⦃ 𝕊 ⦄ ⦃ 𝕊' ⦄ ⦃ 𝕂₂ ⦄ {µ₁} {µ₂} {µ₃} m ϕ₁ ϕ₂ mx x@(here refl) =
    let 𝕤' = SubWithLaws.SubWithLaws-Sub 𝕊' in
    apₖ ((ϕ₁ ₛ· ϕ₂) ↑ m) _ x                             ≡⟨ apₖ-↑-here (ϕ₁ ₛ· ϕ₂) ⟩
    ` here refl                                          ≡⟨ sym (id/`/id _) ⟩
    `/id ⦃ 𝕂₂ ⦄ _ (id/` _ (here refl))                   ≡⟨ cong (`/id _) (sym (apₖ-↑-here ϕ₂)) ⟩
    `/id _ (apₖ ⦃ 𝕤' ⦄ (_↑_ ⦃ 𝕤' ⦄ ϕ₂ m) _ (here refl))  ≡⟨ sym (⋯-var (here refl) (ϕ₂ ↑ m)) ⟩
    (` here refl) ⋯ (ϕ₂ ↑ m)                             ≡⟨ cong (_⋯ ϕ₂ ↑ m) (sym (apₖ-↑-here ϕ₁)) ⟩
    _⋯_ ⦃ 𝕂₂ ⦄ ⦃ 𝕤' ⦄ (apₖ ⦃ 𝕤' ⦄ (ϕ₁ ↑ m) _ x) (ϕ₂ ↑ m) ≡⟨ sym (apₖ-post (ϕ₁ ↑ m) (λ _ t → t ⋯ (ϕ₂ ↑ m)) x) ⟩
    apₖ ((ϕ₁ ↑ m) ₛ· (ϕ₂ ↑ m)) _ x                       ∎
  dist-↑-ₛ· ⦃ 𝕊 ⦄ ⦃ 𝕊' ⦄ ⦃ 𝕂₂ ⦄ {µ₁} {µ₂} {µ₃} m ϕ₁ ϕ₂ mx x@(there y) =
    let 𝕤' = SubWithLaws.SubWithLaws-Sub 𝕊' in
    let 𝕤 = SubWithLaws.SubWithLaws-Sub 𝕊 in
    apₖ ((ϕ₁ ₛ· ϕ₂) ↑ m) _ x                             ≡⟨ apₖ-↑-there (ϕ₁ ₛ· ϕ₂) y ⟩
    wk _ (apₖ (ϕ₁ ₛ· ϕ₂) _ y)                            ≡⟨ cong (wk _) (apₖ-post ϕ₁ (λ _ t → t ⋯ ϕ₂) y) ⟩
    wk _ (apₖ ϕ₁ _ y ⋯ ϕ₂)                               ≡⟨⟩
    apₖ ϕ₁ _ y ⋯ ϕ₂ ⋯ᵣ wkₖ _ id                          ≡⟨ {!!} ⟩
    apₖ ϕ₁ _ y ⋯ (_ᵣ·_ ⦃ 𝕤 ⦄ ⦃ 𝕂₂ ⦄ (wkₖ ⦃ 𝕤 ⦄ ⦃ kitᵣ ⦄ _ id) (ϕ₂ ↑ m))                  ≡⟨ ? ⟩
