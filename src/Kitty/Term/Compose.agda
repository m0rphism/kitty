...
record ComposeTraversal : Set₁ where
  ...
  dist-↑-ₛ· : ∀ ⦃ 𝕂₂ : Kit ⦄ {µ₁} {µ₂} {µ₃} m
                (ϕ₁ : µ₁ –[ kitₛ ]→ µ₂)
                (ϕ₂ : µ₂ –[ 𝕂₂ ]→ µ₃)
              → ((ϕ₁ ₛ· ϕ₂) ↑ m) ~ ((ϕ₁ ↑ m) ₛ· (ϕ₂ ↑ m))
  dist-↑-ₛ· ⦃ 𝕂₂ ⦄ {µ₁} {µ₂} {µ₃} m ϕ₁ ϕ₂ mx x@(here refl) =
