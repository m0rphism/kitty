...
-- --     let sub'' = subst (µ₂ ∋/⊢[ 𝕂 ]_) (ι-id/m→M m) in
-- --     let sub₁ = subst (µ₂ ∋/⊢[ 𝕂 ]_) (sym (ι-id/m→M m)) in
-- --     apₖ (⦅ x/t ⦆ ·[ C₁ ] ϕ) _ x                               ≡⟨ &/⋯-·ₖ ⦅ x/t ⦆ ϕ x ⟩
-- --     sub (apₖ ⦅ x/t ⦆ _ x &/⋯ ϕ)                              ≡⟨ cong (λ ■ → sub (■ &/⋯ ϕ)) (~→~' (⦅⦆-,ₖ x/t) _ x) ⟩
-- --     sub (apₖ (id ,ₖ x/t) _ x &/⋯ ϕ)                          ≡⟨ cong (λ ■ → sub (■ &/⋯ ϕ)) (apₖ-,ₖ-here id x/t) ⟩
-- --     sub (x/t &/⋯ ϕ)                                          ≡⟨ sym (cancel-subst' (µ₂ ∋/⊢[ 𝕂 ]_) (ι-id/m→M m) (sub (x/t &/⋯ ϕ))) ⟩
-- --     sub'' (sub₁ (sub (x/t &/⋯ ϕ)))                           ≡⟨ cong sub'' (sym (ι-∋/⊢-id refl _)) ⟩
-- --     sub'' (ι-∋/⊢ (sub (x/t &/⋯ ϕ)))                          ≡⟨ cong (λ ■ → sub'' (ι-∋/⊢ ■))
-- --                                                                       (sym (apₖ-,ₖ-here id (sub (x/t &/⋯[ C₁ ] ϕ)))) ⟩
-- --     sub'' (ι-∋/⊢ (apₖ ⦃ 𝕂 = 𝕂 ⦄ (id ,ₖ sub (x/t &/⋯[ C₁ ] ϕ)) _ (here refl))) ≡⟨ cong (λ ■ → sub'' (ι-∋/⊢ ■)) (sym (~→~' (⦅⦆-,ₖ (sub (x/t &/⋯[ C₁ ] ϕ))) _ (here refl))) ⟩
-- --     sub'' (ι-∋/⊢ (apₖ ⦃ 𝕂 = 𝕂 ⦄ ⦅ sub (x/t &/⋯[ C₁ ] ϕ) ⦆ _ (here refl))) ≡⟨ sym (&/⋯-ap ⦃ C₂ ⦄ (here refl)
-- --                                                                                               ⦅ sub (x/t &/⋯[ C₁ ] ϕ) ⦆) ⟩
-- --     sub' (id/` _ (here refl) &/⋯ ⦅ sub (x/t &/⋯[ C₁ ] ϕ) ⦆)   ≡⟨ cong (λ ■ → sub' (■ &/⋯ ⦅ sub (x/t &/⋯[ C₁ ] ϕ) ⦆))
-- --                                                                         (sym (apₖ-↑-here ϕ)) ⟩ 
-- --     sub' (apₖ (ϕ ↑ m) _ x &/⋯ ⦅ sub (x/t &/⋯[ C₁ ] ϕ) ⦆)      ≡⟨ sym (&/⋯-·ₖ (ϕ ↑ m) ⦅ sub (x/t &/⋯[ C₁ ] ϕ) ⦆ x) ⟩
-- --     apₖ ((ϕ ↑ m) ·[ C₂ ] ⦅ sub (x/t &/⋯[ C₁ ] ϕ) ⦆) _ x        ∎
-- --   mx x@(there y) →
-- --     let sub = subst (µ₂ ∋/⊢[ 𝕂 ]_) (ι-id/m→M ⦃ 𝕂₁⊑𝕂₁⊔𝕂₂ ⦃ C₁ ⦄ ⦄ m) in
-- --     let sub' = subst (µ₂ ∋/⊢[ 𝕂 ]_) (ι-id/m→M ⦃ 𝕂₁⊑𝕂₁⊔𝕂₂ ⦃ C₁ ⦄ ⦄ mx) in
-- --     let sub'' = subst (µ₂ ∋/⊢[ 𝕂 ]_) (ι-id/m→M ⦃ 𝕂₁⊑𝕂₁⊔𝕂₂ ⦃ C₂ ⦄ ⦄ mx) in
-- --     let sub₂ = subst (µ₂ ∋/⊢[ 𝕂 ]_) (ι-id/m→M ⦃ 𝕂₂⊑𝕂₁⊔𝕂₂ ⦃ C₁ ⦄ ⦄ mx) in
-- --     apₖ (⦅ x/t ⦆ ·[ C₁ ] ϕ) _ x                               ≡⟨ &/⋯-·ₖ ⦅ x/t ⦆ ϕ x ⟩
-- --     sub' (apₖ ⦅ x/t ⦆ _ x &/⋯ ϕ)                             ≡⟨ cong (λ ■ → sub' (■ &/⋯[ C₁ ] ϕ)) (~→~' (⦅⦆-,ₖ x/t) _ x) ⟩
-- --     sub' (apₖ (id ,ₖ x/t) _ x &/⋯ ϕ)                         ≡⟨ cong (λ ■ → sub' (■ &/⋯[ C₁ ] ϕ)) (apₖ-,ₖ-there id x/t y) ⟩
-- --     sub' (apₖ id _ y &/⋯ ϕ)                                  ≡⟨ cong (λ ■ → sub' (■ &/⋯[ C₁ ] ϕ)) (apₖ-id y) ⟩
-- --     sub' (id/` _ y &/⋯ ϕ)                                    ≡⟨ &/⋯-ap y ϕ ⟩
-- --     sub₂ (ι-∋/⊢ ⦃ 𝕂₂⊑𝕂₁⊔𝕂₂ ⦃ C₁ ⦄ ⦄ (apₖ ϕ _ y))              ≡⟨ {!!} ⟩
-- --     apₖ (ϕ ·[ C₂ ] id) _ y                                    ≡⟨ {!!} ⟩
-- --     apₖ (wkₖ _ ϕ ·[ C₂ ] ⦅ sub (x/t &/⋯[ C₁ ] ϕ) ⦆) _ y      ≡⟨ &/⋯-·ₖ ⦃ C₂ ⦄ (wkₖ _ ϕ) ⦅ sub (x/t &/⋯[ C₁ ] ϕ) ⦆ y ⟩
-- --     sub'' (apₖ (wkₖ _ ϕ) _ y &/⋯ ⦅ sub (x/t &/⋯[ C₁ ] ϕ) ⦆) ≡⟨ cong (λ ■ → sub'' (■ &/⋯ ⦅ sub (x/t &/⋯[ C₁ ] ϕ) ⦆))
-- --                                                                       (apₖ-wkₖ-wk ϕ y) ⟩
-- --     sub'' (wk _ (apₖ ϕ _ y) &/⋯ ⦅ sub (x/t &/⋯[ C₁ ] ϕ) ⦆)  ≡⟨ cong (λ ■ → sub'' (■ &/⋯ ⦅ sub (x/t &/⋯[ C₁ ] ϕ) ⦆))
-- --                                                                       (sym (apₖ-↑-there ϕ y)) ⟩ 
-- --     sub'' (apₖ (ϕ ↑ m) _ x &/⋯ ⦅ sub (x/t &/⋯[ C₁ ] ϕ) ⦆)   ≡⟨ sym (&/⋯-·ₖ ⦃ C₂ ⦄ (ϕ ↑ m) ⦅ sub (x/t &/⋯[ C₁ ] ϕ) ⦆ x) ⟩
-- --     apₖ ((ϕ ↑ m) ·[ C₂ ] ⦅ sub (x/t &/⋯[ C₁ ] ϕ) ⦆) _ x      ∎
