...
--     t ⋯ ϕ₁' ⋯ ϕ₂'  ∎
  ...
  wk-cancels-,ₖ :
    ...
    → t ⋯ wkn ⦃ 𝕂 = 𝕂₁ ⦄ ⋯ (ϕ ,ₖ x/t) ≡ t ⋯ ϕ
  wk-cancels-,ₖ ⦃ 𝕂₁ ⦄ ⦃ 𝕂₂ ⦄ ⦃ 𝕂 ⦄ ⦃ C = C ⦄ t ϕ x/t =
    t ⋯ wkn ⦃ 𝕂 = 𝕂₁ ⦄ ⋯ (ϕ ,ₖ x/t)        ≡⟨ ⋯-assoc ⦃ 𝔸 = C ⦄ t (wkₖ _ id) (ϕ ,ₖ x/t) ⟩
    t ⋯ (wkn ⦃ 𝕂 = 𝕂₁ ⦄ ·[ C ] (ϕ ,ₖ x/t)) ≡⟨ ~-cong-⋯ _ (wk-cancels-,ₖ-· ⦃ C = C ⦄ ϕ x/t) ⟩
    t ⋯ ϕ                                  ∎
  ...
  wkₛ-cancels-,ᵣ :
    ∀ (t : S₁ ⊢ s') (ϕ : S₁ →ᵣ S₂) (x : S₂ ∋ s) →
    t ⋯ wknₛ ⋯ (ϕ ,ₖ x) ≡ t ⋯ ϕ
  wkₛ-cancels-,ᵣ = wk-cancels-,ₖ ⦃ C = ckitₛᵣ ⦄

  wkₛ-cancels-,ₛ :
    ∀ (t : S₁ ⊢ s') (ϕ : S₁ →ₛ S₂) (t' : S₂ ⊢ s) →
    t ⋯ wknₛ ⋯ (ϕ ,ₖ t') ≡ t ⋯ ϕ
  wkₛ-cancels-,ₛ = wk-cancels-,ₖ ⦃ C = ckitₛₛ ⦄
...
--   record ComposeTraversalLemmas : Set₁ where
  ...
  wk-cancels-⦅⦆ ⦃ 𝕂₁ ⦄ ⦃ 𝕂₂ ⦄ ⦃ 𝕂 ⦄ ⦃ C₁ ⦄ ⦃ C₂ ⦄ t x/t =
    t ⋯ wkn ⦃ 𝕂 = 𝕂₁ ⦄ ⋯ ⦅ x/t ⦆     ≡⟨ ~-cong-⋯ (t ⋯ wkn ⦃ 𝕂 = 𝕂₁ ⦄) (⦅⦆-,ₖ x/t) ⟩
    t ⋯ wkn ⦃ 𝕂 = 𝕂₁ ⦄ ⋯ (id ,ₖ x/t) ≡⟨ wk-cancels-,ₖ t id x/t ⟩
    t ⋯ id                           ≡⟨ ⋯-id t ⟩
    t                                ∎
