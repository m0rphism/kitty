...
record ComposeTraversal : Set (lsuc ℓ) where
  ...
  dist-↑-⦅⦆-· ⦃ 𝕂₁ ⦄ ⦃ 𝕂₂ ⦄ ⦃ 𝕂 ⦄ ⦃ W₁ ⦄ ⦃ W₂ ⦄ ⦃ W ⦄ ⦃ C₁ ⦄ ⦃ C₂ ⦄ ⦃ C₃ ⦄ {µ₁} {µ₂} {m} x/t ϕ = mk-~ λ where
    mx x@(here refl) →
