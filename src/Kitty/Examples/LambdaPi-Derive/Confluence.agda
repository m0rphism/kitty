...
↪σ-⋯ : ∀ {µ₁ µ₂ m} {t t' : µ₁ ⊢ m} {σ σ' : µ₁ →ₛ µ₂} →
  ...
  t ⋯ σ ↪ₚ t' ⋯ σ'
↪σ-⋯ ξ-`                   σ↪σ' = σ↪σ' _
↪σ-⋯ {σ = σ} {σ'} (β-λ {t₁' = t₁'} {t₂' = t₂'} t₁↪ₚt₁' t₂↪ₚt₂') σ↪σ' = subst (_ ↪ₚ_) (sym (dist-⦅⦆ₛ-⋯ₛ t₁' t₂' σ'))
                                                                             (β-λ (↪σ-⋯ t₁↪ₚt₁' (↪ₚσ-↑ σ↪σ')) (↪σ-⋯ t₂↪ₚt₂' σ↪σ'))
↪σ-⋯ (ξ-λ t↪ₚt')           σ↪σ' = ξ-λ (↪σ-⋯ t↪ₚt' (↪ₚσ-↑ σ↪σ'))
↪σ-⋯ (ξ-∀ t₁↪ₚt₁' t₂↪ₚt₂') σ↪σ' = ξ-∀ (↪σ-⋯ t₁↪ₚt₁' σ↪σ') (↪σ-⋯ t₂↪ₚt₂' (↪ₚσ-↑ σ↪σ'))
↪σ-⋯ (ξ-· t₁↪ₚt₁' t₂↪ₚt₂') σ↪σ' = ξ-· (↪σ-⋯ t₁↪ₚt₁' σ↪σ') (↪σ-⋯ t₂↪ₚt₂' σ↪σ')
↪σ-⋯ ξ-★                   σ↪σ' = ξ-★
...
↪σ-⋯-⦅⦆ : ∀ {µ M} {t₁ t₁' : (µ ▷ 𝕖) ⊢ M}  {t₂ t₂' : µ ⊢ 𝕖} →
  t₁ ↪ₚ t₁' →
  t₂ ↪ₚ t₂' →
  t₁ ⋯ ⦅ t₂ ⦆ₛ ↪ₚ t₁' ⋯ ⦅ t₂' ⦆ₛ
↪σ-⋯-⦅⦆ t₁↪ₚt₁' t₂↪ₚt₂' = ↪σ-⋯ t₁↪ₚt₁' ↪ₚσ-⦅ t₂↪ₚt₂' ⦆
...
...  | T₁ , t₁'↪T₁ , t₁''↪T₁  | T₂ , t₂'↪T₂ , t₂''↪T₂
  = T₁ ⋯ₛ ⦅ T₂ ⦆ₛ , ↪σ-⋯ t₁'↪T₁ ↪ₚσ-⦅ t₂'↪T₂ ⦆ , ↪σ-⋯ t₁''↪T₁ ↪ₚσ-⦅ t₂''↪T₂ ⦆
diamond (β-λ {t₁' = t₁'} t₁↪t₁' t₂↪t₂') (ξ-· (ξ-λ t₁↪t₁'') t₂↪t₂'')
  with diamond t₁↪t₁' t₁↪t₁'' | diamond t₂↪t₂' t₂↪t₂''
...  | T₁ , t₁'↪T₁ , t₁''↪T₁  | T₂ , t₂'↪T₂ , t₂''↪T₂
  = T₁ ⋯ₛ ⦅ T₂ ⦆ₛ , ↪σ-⋯ t₁'↪T₁ ↪ₚσ-⦅ t₂'↪T₂ ⦆ , (β-λ t₁''↪T₁ t₂''↪T₂)
...
diamond (ξ-· (ξ-λ t₁↪t₁') t₂↪t₂') (β-λ t₁↪t₁'' t₂↪t₂'')
  with diamond t₁↪t₁' t₁↪t₁'' | diamond t₂↪t₂' t₂↪t₂''
...  | T₁ , t₁'↪T₁ , t₁''↪T₁  | T₂ , t₂'↪T₂ , t₂''↪T₂
  = T₁ ⋯ₛ ⦅ T₂ ⦆ₛ , β-λ t₁'↪T₁ t₂'↪T₂ , ↪σ-⋯ t₁''↪T₁ ↪ₚσ-⦅ t₂''↪T₂ ⦆
diamond (ξ-· t₁↪t₁' t₂↪t₂') (ξ-· t₁↪t₁'' t₂↪t₂'')
  with diamond t₁↪t₁' t₁↪t₁'' | diamond t₂↪t₂' t₂↪t₂''
...  | T₁ , t₁'↪T₁ , t₁''↪T₁  | T₂ , t₂'↪T₂ , t₂''↪T₂
