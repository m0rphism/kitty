...
\begin{document}
  ...
  For example a term of type \texttt{[𝕖, 𝕥] ⊢ 𝕖} is an expression with two free variables, where variable 0 is a placeholder for an expression, and variable 1 for a type.
  \LibCode\KSortTy
  ...
  separately and use renamings to weaken substitutions when going under binders.
