...
\begin{document}
  ...
  the lemma of the \ACode{\ACon{ComposeTraversal}} needs to be proved for
  an abstract \ACode{\ACon{ComposeKit}} and in return defines the
  four concrete \ACode{\ACon{ComposeKit}} instances for us. This allows us to break
  ...
  \ACode{\ACon{TypingTraversal}}, which provides
  substitution-preserves-typing for all \ACode{\ACon{TypingKit}}s.
  \LibCode\KTypingKit
