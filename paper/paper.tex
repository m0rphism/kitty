...
\begin{document}
  ...
  operation, which again doubles the repetition.
  ...
  If one is not careful, a formalization with three sorts of variables
  can easily end up with 24 definitions for each operation related
  to substitution, which usually includes at least a substitution type, and
  operations for application, extension, weakening, lifting, singleton
  substitution, extensional equality, and an identity substitution.
