...
\begin{document}
  ...
  \ACode{\ADef{Ctx} S} describes type contexts with bindings for variables from \ACode{S}
  ...
  states that \ACode{\ADef{lookup} Γ x} is \ACode{t}.
  ...
  \LibCode\KTKit
  The fields of a \ACode{\ACon{TKit}} are completely analogous to
  those of a \ACode{\ACon{Kit}}, but talk about typing instead of terms.
