...
\begin{document}
  ...
  Together with abstractions to unify renamings and substitutions,
  this allows us to create an abstraction that is general enough to
  prove type preservation for all sub
  ...
  Frameworks for programming languages metatheory can be broadly
  categorized by representation of variable bindings, representation
  of typing and scoping, and requirements on the meta-language.
  ...
  broader picture. In particular we cover abstractions for renamings
