...
\begin{document}
  ...
  and type contexts for multi-sorted syntax.
  ...
  Equipped with a notion of types, we define a type context as a
  ...
  by the type context to use all variables bound previously in the type context.
  ...
  To use a type returned from a type context, it needs to be
