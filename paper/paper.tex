...
\begin{document}
  ...
  Having unified the untyped substitution machinery, we build further
  abstractions to similarly unify typing and type preservation lemmas.
  Our reflection algorithm instanciates those abstractions
