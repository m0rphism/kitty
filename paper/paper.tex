...
\begin{document}
  ...
  The full framework is available on Github: \textcolor{blue}{\url{https://github.com/m0rphism/kitty}}
  ...
  \item 
    In pure type systems, sorts are universes, e.g. as
    in Agda a type has itself type \ACode{Set} or a kind has type \ACode{Set₁}.
