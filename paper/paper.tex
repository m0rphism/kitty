...
\begin{document}
  ...
  as a type preservation lemma for that operation, as it has to
  ...
  However, hope is not lost for extrinsic typing to keep up with the
  conciseness of intrinsic typing: 
  ...
  space. The omitted proofs can be found in Appendix~\ref{sec:proofs} and the
