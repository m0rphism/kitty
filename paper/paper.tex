...
\begin{document}
  ...
  We then define a \ACode{\ACon{ComposeTraversal}}, which consists of the
  \ACode{\AField{⋯-fusion}} lemma for general maps.
  Just like a \ACode{\ACon{Traversal}} allowed us to bootstrap the two
  \ACode{\ACon{Kit}} instances, the \ACode{\ACon{ComposeTraversal}} allows
  us to bootstrap the four \ACode{\ACon{ComposeKit}} instances.
  ...
  The \ACode{\ACon{ComposeKit}} abstraction provides the
  \ACode{\AField{\_\&/⋯\_}} operation, necessary for defining
  composition, and two lemmas about its behavior:
  \LibCode\KComposeKit
  ...
  We later define four instances for \ACode{\ACon{ComposeKit}}, where
  \ACode{K₁} and \ACode{K₂} can each be either the variable or term kit.
  ...
  \item 
    Given the \ACode{\ADef{⋯-↑-wk}} lemma, we can define the four
    \ACode{\ACon{ComposeKit}} instances:
