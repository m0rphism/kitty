...
\begin{document}
  ...
  reduction.
  When working without library support, intrinsic typing often has the
  benefit of more concise code, as shared structure between definitions
  and preservation lemmas does not need to be repeated.
