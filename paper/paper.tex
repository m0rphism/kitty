...
\begin{document}
  ...
  Finally, we instanciate the \ACode{\ACon{Traversal}} structure:
  ...
  be instanciated separately for variables and terms: the counterpiece
  ...
  \item 
    ...
    followed by the singleton substitution with \ACode{ϕ} applied to its term:
  ...
  Finally, we instantiate the \ACode{\ACon{ComposeTraversal}} for
  System F to make the composition machinery available:
  \AppCode\FFusion
