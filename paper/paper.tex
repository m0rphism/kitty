...
\begin{document}
  ...
  \ACode{\ACon{Kit}} could not use the \ACode{\ACon{\_⋯\_}} function in
  their types.
  ...
  reason about the application of multiple maps in terms of
  ...
  Benton et al.\cite{DBLP:journals/jar/BentonHKM12} addresses this
  ...
  dependencies.
  This has the benefit, that we can prove lemmas about
  the composition of arbitrary maps, which enable us later to unify type
  ...
  define a general composition in the spirit of:
  ...
  structure needs to be instantiated by the application with
  ...
  from the the axioms of a \ACode{\ACon{ComposeKit}}:
  \begin{itemize}
  \item
  ...
  which provides the \ACode{\ACon{⋯-fusion}} for the compositions
  ...
  definitions from the the axiom of a \ACode{\ACon{ComposeTraversal}}:
  \begin{itemize}
  \item 
  ...
  \item
    ...
    needs to lift the map via \ACode{\ADef{\_↑\_}}, requiring us to
  ...
  generic programming technique and instantiated the structures
